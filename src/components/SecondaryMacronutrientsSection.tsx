    ...
    <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-1">
      <Card className="bg-gray-50 border-gray-200">
        ...
        <CardContent className="pt-0 px-1 pb-1">
          <FormattedInput
            ...
            onChange={onSChange}
            placeholder="0,0"
            className={`h-5 text-[8px] ${errors.S ? 'border-red-500' : ''}`}
          />
      ...
      <Card className="bg-gray-50 border-gray-200">
        <CardHeader className="pb-0 pt-1 px-1">
          ...
          <CardDescription className="text-[6px]">%</CardDescription>
        </CardHeader>
        <CardContent className="pt-0 px-1 pb-1">
          <FormattedInput
            value={organicMatter}
            ...
            placeholder="0,0"
            className={`h-5 text-[8px] ${errors.organicMatter ? 'border-red-500' : ''}`}
          />
